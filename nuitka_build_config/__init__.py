...
class NuitkaBuilder:
    ...
    def _convert_argv(self, argv: StrList) -> StrList:
        pass
    ...
    def argv(self) -> StrList:
        ...
        for key, value in config.items():
            self._get_argv_add_method(key)(argv, value)
        return argv
